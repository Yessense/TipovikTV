...
# find_несмещенная_выборочная_дисперсия_и_все_прочее([-4,0,4,10],[8,28,16,9])

find_h1h2h3_brak(0.4,0.35,0.25,0.3,0.2,0.4,5)


# p_less_than_1 = 1- stats.binom.cdf(n=11,p=0.1,k=1)
# print(p_less_than_1)